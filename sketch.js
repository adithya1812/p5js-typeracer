...
function draw() {
  ...
  textSize(48);
  fill("#E0E1DD");
  text("Monkeytype V2", width / 2, 100);
  textSize(30);
  textAlign(LEFT);
  text(
    'Welcome to my typeracer! This is a game where you have to match the text on the screen by typing it out as fast as you can. There are three options to choose from - 10 words, 25 words, and 50 words - and these will determine the number of words in your typeracer. Pressing the button "Click to Start" will initiate the game. Hope you enjoy my typeracer!',
    50,
    125,
    windowWidth - 50
  );
  ...
  if (flag == true) {
    ...
    if (ans == result) {
      noLoop();
      text(
        "Good job! You completed the typeracer",
        50,
        height - 160,
        windowWidth - 50
      );
